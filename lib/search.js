...
Search.from = function(date) {
    var facet = 'begin_time';
    this.facets.push('facet=' + facet);
    this.facets.push(facet + '=' + date);
    return this;
};

Search.to = function(date) {
    var facet = 'end_time';
    this.facets.push('facet=' + facet);
    this.facets.push(facet + '=' + date);
    return this;
...
Search.sector = function(sector) {
    ...
    this.facets.push('facet=' + facet);
    this.facets.push(facet + '=' + facetValue.element);
    return this;
};
...
Search.get = function() {
    var uri = 'search?query=' + this.query + '&' + this.facets.join('&');
    return request.call(this.ctx, uri, { json: true });
};


var SearchMethod = function() {
    SearchMethod.ctx = this;
    return SearchMethod;
};
